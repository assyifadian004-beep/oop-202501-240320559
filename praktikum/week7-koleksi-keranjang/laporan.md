...
public class MainCart {
    public static void main(String[] args) {
        System.out.println("Hello, I am As Syifa Dian Rinesti-240320559 (Week7-collections)");
