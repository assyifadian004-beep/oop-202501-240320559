...
![Screenshot hasil](hasil pengujian.png)
![Screenshot hasil](SS-WEEK10.png)
)
---
...
4. [Apa risiko jika Singleton tidak diimplementasikan dengan benar?]
   **Jawaban:** ika Singleton tidak diimplementasikan dengan benar, dapat terjadi lebih dari satu instance dalam aplikasi. Hal ini berisiko menimbulkan inkonsistensi data, pemborosan sumber daya, serta perilaku program yang tidak terduga, terutama pada komponen yang seharusnya bersifat global seperti koneksi database.